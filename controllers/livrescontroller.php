...
$requeteLivre = 'SELECT livres.NOM_LIVRE , auteur.NOM_AUTEUR, editeur.NOM_EDITEUR FROM livres JOIN auteur ON auteur.ID_AUTEUR = livres.ID_AUTEUR JOIN editeur ON editeur.ID_EDITEUR = livres.ID_AUTEUR;';
